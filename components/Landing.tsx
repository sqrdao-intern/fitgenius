    ...
    <div className="flex flex-col items-center justify-center py-8 md:py-20 animate-fadeIn w-full">
      <div className="text-center max-w-4xl mx-auto mb-16 px-4">
         ...
         <p className="text-lg md:text-xl text-zinc-400 mb-10 max-w-2xl mx-auto leading-relaxed">
            Stop guessing. Start progressing. FitGenius creates a hyper-personalized workout curriculum adapted to your goals, equipment, and recovery.
         </p>
         ...
         {[
            {
               ...
               desc: "We analyze your age, experience, and goals to calibrate intensity and volume perfectly."
            },
            {
               ...
               desc: "Smart progressive overload ensures you never hit a plateau. Every week is optimized."
            },
            {
               ...
               bg: "bg-purple-500/10",
               title: "Form & Safety",
               desc: "AI-generated visuals and expert cues keep your form strict and your joints healthy."
            }
         ].map((feature, idx) => (
